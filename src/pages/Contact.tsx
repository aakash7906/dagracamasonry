...
export function Contact() {
  ...
  return (
    <div className="py-12 lg:py-20 bg-stone-900 text-stone-100 min-h-screen">
      {/* Header Banner */}
      <Container className="mb-14">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {/* Card 1: Direct Phone */}
          <div className="p-6 rounded-2xl bg-stone-950 border border-stone-800 hover:border-amber-500/40 transition-all flex flex-col justify-between group">
            <div className="space-y-3">
              <div className="h-12 w-12 rounded-xl bg-amber-600/10 text-amber-500 flex items-center justify-center group-hover:scale-105 transition-transform">
                <Phone className="h-6 w-6" />
              </div>
              <h3 className="font-heading font-bold text-white text-lg">Direct Phone</h3>
              ...
              <div className="space-y-1">
                <a
                  href="tel:9085557866"
                  className="block text-base font-bold text-amber-400 hover:text-amber-300 transition-colors"
                >
                  (908) 555-STONE
                </a>
                <span className="block text-xs text-stone-400">Alt: (908) 555-7866</span>
              </div>
            </div>
            <div className="pt-4 mt-4 border-t border-stone-800 text-[11px] text-stone-400 flex items-center gap-1.5">
          ...
          <div className="p-6 rounded-2xl bg-stone-950 border border-stone-800 hover:border-amber-500/40 transition-all flex flex-col justify-between group">
            <div className="space-y-3">
              ...
              <h3 className="font-heading font-bold text-white text-lg">Email & Drawings</h3>
              <p className="text-xs text-stone-400">
              ...
              <div className="space-y-1">
                <a
                  ...
                  className="block text-sm font-bold text-amber-400 hover:text-amber-300 transition-colors truncate"
                >
                  estimates@dagracamasonry.com
                </a>
                <span className="block text-xs text-stone-400">info@dagracamasonry.com</span>
              </div>
            </div>
            <div className="pt-4 mt-4 border-t border-stone-800 text-[11px] text-stone-400 flex items-center gap-1.5">
          ...
          <div className="p-6 rounded-2xl bg-stone-950 border border-stone-800 hover:border-amber-500/40 transition-all flex flex-col justify-between group">
            <div className="space-y-3">
              ...
              <h3 className="font-heading font-bold text-white text-lg">HQ & Yard</h3>
              <p className="text-xs text-stone-400">
              ...
              <div className="space-y-0.5 text-xs text-stone-300 font-medium">
                ...
                <p className="text-stone-400">Somerset County, New Jersey</p>
              </div>
            </div>
            <div className="pt-4 mt-4 border-t border-stone-800 text-[11px] text-stone-400 flex items-center gap-1.5">
          ...
          <div className="p-6 rounded-2xl bg-stone-950 border border-stone-800 hover:border-amber-500/40 transition-all flex flex-col justify-between group">
            <div className="space-y-3">
              ...
              <h3 className="font-heading font-bold text-white text-lg">Service Territory</h3>
              <p className="text-xs text-stone-400">
      ...
      <Container className="mb-20">
        <div className="rounded-3xl bg-stone-950 border border-stone-800 p-8 sm:p-12 lg:p-16 shadow-2xl">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              <div className="p-6 rounded-2xl bg-stone-900 border border-stone-800 space-y-4">
                ...
                <div className="space-y-3 text-xs text-stone-300">
                  <div className="flex items-start gap-3">
                    <span className="h-5 w-5 rounded-full bg-amber-500/20 text-amber-400 flex items-center justify-center font-bold shrink-0">
                      1
                    </span>
                    <span>
                      <strong className="text-white">Review & Initial Phone Chat:</strong> An estimator evaluates your project requirements within 24 hours.
                    </span>
                  </div>
                  <div className="flex items-start gap-3">
                    <span className="h-5 w-5 rounded-full bg-amber-500/20 text-amber-400 flex items-center justify-center font-bold shrink-0">
                    ...
                    <span>
                      <strong className="text-white">On-Site Site Survey:</strong> We walk your property, take elevations, and review material samples in person.
                    </span>
                  </div>
                  <div className="flex items-start gap-3">
                    <span className="h-5 w-5 rounded-full bg-amber-500/20 text-amber-400 flex items-center justify-center font-bold shrink-0">
                    ...
                    <span>
                      <strong className="text-white">Detailed Line-Item Quote:</strong> Complete scope breakdown, stone specifications, timeline, and warranty terms.
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="p-5 rounded-2xl bg-amber-500/10 border border-amber-500/30 flex items-start gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <a
                    href="tel:9085557866"
                    className="inline-block pt-1 text-xs font-bold text-amber-400 hover:underline"
                  >
            ...
            <div className="lg:col-span-7">
              <div className="rounded-2xl bg-stone-900 border border-stone-800 p-6 sm:p-10 shadow-lg">
                {submitted ? (
                  <motion.div
                  ...
                  >
                    <div className="h-20 w-20 bg-amber-500/20 text-amber-400 rounded-full flex items-center justify-center mx-auto border border-amber-500/40">
                    ...
                    <p className="text-stone-300 text-sm max-w-lg mx-auto leading-relaxed">
                      Thank you for contacting <strong className="text-amber-400">Da Graca Masonry</strong>. Your project details have been assigned to our senior masonry estimator. We will review your requirements and reach out via phone or email within 24 business hours.
                    </p>
                    <div className="pt-4">
                      <Button
                        variant="outline"
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <p className="text-xs text-stone-400 -mt-3 mb-6">
                      Fields marked with an asterisk (<span className="text-amber-500">*</span>) are required.
                    </p>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-2.5 rounded-xl bg-stone-950 border border-stone-700 text-sm text-white placeholder-stone-500 focus:outline-none focus:border-amber-500 focus:ring-1 focus:ring-amber-500"
                        />
                      </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div>
                        <label className="block text-xs font-semibold text-stone-300 mb-1.5">
                          City / Municipality & Zip <span className="text-amber-500">*</span>
                        </label>
                        <input
                          type="text"
                          required
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        <label className="block text-xs font-semibold text-stone-300 mb-1.5">
                          Primary Masonry Discipline <span className="text-amber-500">*</span>
                        </label>
                        <select
                          value={formData.serviceType}
                          onChange={(e) => setFormData({ ...formData, serviceType: e.target.value })}
                          className="w-full px-4 py-2.5 rounded-xl bg-stone-950 border border-stone-700 text-sm text-white focus:outline-none focus:border-amber-500 focus:ring-1 focus:ring-amber-500"
                        >
                    ...
                    <div>
                      <label className="block text-xs font-semibold text-stone-300 mb-1.5">
                        Project Scope, Stone Preferences & Details <span className="text-amber-500">*</span>
                      </label>
                      <textarea
                        rows={4}
                        required
                        ...
                        className="w-full px-4 py-3 rounded-xl bg-stone-950 border border-stone-700 text-sm text-white placeholder-stone-500 focus:outline-none focus:border-amber-500 focus:ring-1 focus:ring-amber-500 resize-none"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      >
                        ...
                        />
                        <UploadCloud className="h-7 w-7 text-amber-500 mx-auto mb-2" />
                        {formData.fileName ? (
                          ...
                          <>
                            <p className="text-xs text-stone-300 font-medium">
                              Drag and drop blueprints or site photos here, or <span className="text-amber-400 underline">browse files</span>
                            </p>
                    ...
                    <div className="pt-2">
                      <Button
                        type="submit"
                        size="lg"
                        className="w-full bg-amber-600 hover:bg-amber-500 text-stone-950 font-bold text-base py-6 shadow-xl"
                      >
                  ...
                  <AnimatePresence>
                    {isOpen && (
                      <motion.div
                        ...
                        className="px-6 pb-6 text-stone-300 text-sm leading-relaxed border-t border-stone-800/80 pt-4"
                      >
                        {faq.a}
                      </motion.div>
                    )}
