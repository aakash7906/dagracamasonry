...
export function Footer() {
  ...
  return (
    <footer className="bg-stone-950 text-stone-300 border-t border-stone-800">
      <Container size="full" className="max-w-[1560px] py-12 sm:py-16 px-4 sm:px-6 lg:px-8 xl:px-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10">
          {/* Brand info */}
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="h-10 w-10 rounded-lg bg-[#b45309] flex items-center justify-center text-white shadow-sm">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] uppercase tracking-widest text-amber-400 font-bold -mt-1">
                  Masonry & Stone
                </span>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs sm:text-sm">
              <li>
                <Link to="/services" className="text-stone-400 hover:text-white transition-colors flex items-center justify-between group">
          ...
          <div>
            ...
            <div className="space-y-3 text-xs sm:text-sm">
              <a href="tel:9085557866" className="flex items-center gap-3 text-stone-300 hover:text-amber-400 transition-colors">
                <Phone className="h-4 w-4 text-amber-500 shrink-0" />
                <span className="break-all sm:break-normal">(908) 555-STONE / (908) 555-7866</span>
              </a>
              <a href="mailto:info@dagracamasonry.com" className="flex items-center gap-3 text-stone-300 hover:text-amber-400 transition-colors">
        ...
        {/* Bottom copyright */}
        <div className="mt-10 sm:mt-14 pt-6 sm:pt-8 border-t border-stone-800 flex flex-col sm:flex-row items-center justify-between text-xs text-stone-500 gap-4 text-center sm:text-left">
          ...
          <div className="flex flex-wrap items-center justify-center sm:justify-start gap-4 sm:gap-6">
            ...
            <span className="hover:text-stone-300 transition-colors cursor-pointer">Licensing & Insurance</span>
          </div>
        </div>
      </Container>
    </footer>
