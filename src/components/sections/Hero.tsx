...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-stone-950 py-20 lg:py-28">
      {/* Background stone pattern and radial glow */}
      ...
      <Container className="relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2">
              <Badge variant="stone" className="px-3 py-1.5 text-xs font-semibold uppercase tracking-wider">
            ...
            <p className="text-lg sm:text-xl text-stone-300 max-w-2xl mx-auto lg:mx-0 font-normal leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-2">
              <Button
                size="lg"
                className="w-full sm:w-auto text-base group bg-amber-600 hover:bg-amber-500 text-stone-950 font-bold"
                onClick={() => {
          ...
          >
            <div className="relative mx-auto max-w-md lg:max-w-none">
              ...
              <div className="relative rounded-2xl overflow-hidden border-2 border-stone-700/80 shadow-2xl bg-stone-900 group">
                <img
                ...
                <div className="absolute bottom-6 left-6 right-6 p-4 rounded-xl bg-stone-900/90 backdrop-blur-md border border-stone-700/60 shadow-lg">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-xs uppercase tracking-wider text-amber-400 font-bold">Featured Craft</p>
                      <h4 className="text-white font-heading font-bold text-base">Hand-Split Fieldstone Facade</h4>
                    </div>
                    <Badge variant="stone" className="font-semibold text-xs">
                      Bedminster, NJ
                    </Badge>
                  </div>
                </div>
              ...
              {/* Floating Stat card */}
              <div className="absolute -top-4 -right-4 sm:-right-6 bg-amber-500 text-stone-950 px-4 py-3 rounded-xl shadow-xl font-heading font-black text-center rotate-3 border border-amber-300">
        ...
        {/* Company stats bar */}
        <div className="mt-16 pt-12 border-t border-stone-800 grid grid-cols-2 md:grid-cols-4 gap-6">
          {companyStats.map((stat, i) => (
            ...
            >
              <div className="text-3xl sm:text-4xl font-black font-heading text-amber-400">
                {stat.value}
              </div>
              <div className="text-sm font-semibold text-white">{stat.label}</div>
              <div className="text-xs text-stone-400">{stat.subtext}</div>
            </motion.div>
          ))}
        </div>
      </Container>
