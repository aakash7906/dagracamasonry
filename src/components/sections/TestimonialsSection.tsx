...
export function TestimonialsSection() {
  return (
    <section id="testimonials" className="py-24 bg-stone-100/70 border-b border-stone-200">
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonialsData.map((item) => (
            <div
              key={item.id}
              className="rounded-2xl border border-stone-200 bg-white text-stone-900 shadow-md flex flex-col justify-between hover:border-amber-500 hover:shadow-xl hover:shadow-stone-200/80 transition-all p-6 relative group"
            >
